...
import { sanitizeContactNumber } from "../utils/validators";
          ...
          <div>
            ...
            {activeTab === "karykarta" && (
              <p className="mt-1 text-[11px] text-stone-500">
                કાર્યકર્તાનો મોબાઈલ નંબર તમારું User ID છે.
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {activeTab === "karykarta" && (
              <div className="mt-2 p-2.5 bg-amber-50/80 rounded-xl border border-amber-200/70 text-[11px] text-amber-900 flex items-start gap-2">
                ...
                <span>
                  <strong>નોંધ:</strong> પ્રથમ વખત લોગિન માટે પાસવર્ડ તમારો <strong>મોબાઈલ નંબર</strong> જ છે.
                </span>
              </div>
            )}
          </div>
